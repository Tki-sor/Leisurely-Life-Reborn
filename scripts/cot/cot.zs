...
val tab = mods.contenttweaker.VanillaFactory.createCreativeTab("LLR_item", <item:mysticalagriculture:crafting:5>);
tab.register();
...
function ItemBuilder(name as string,maxn as int,glow as bool){
    ...
    itemt.glowing = glow;
    itemt.creativeTab = <creativetab:LLR_item>;
    itemt.register();
}
...
ItemBuilder("LLR_item_1",64,false);
ItemBuilder("LLR_item_2",64,false);
ItemBuilder("LLR_item_3",64,false);
ItemBuilder("LLR_item_4",64,false);
ItemBuilder("LLR_item_5",64,false);
ItemBuilder("LLR_item_6",64,false);
ItemBuilder("LLR_item_7",64,false);
ItemBuilder("LLR_item_8",64,false);
ItemBuilder("LLR_item_9",64,false);
ItemBuilder("LLR_item_10",64,false);
ItemBuilder("LLR_item_11",64,false);
ItemBuilder("LLR_item_12",64,false);
ItemBuilder("LLR_item_13",64,false);
ItemBuilder("LLR_item_14",64,false);
ItemBuilder("LLR_item_15",64,false);
